const { getObjectId } = require("../database/mongo/mongoQuerie");
...
const router=[
  ...
  getMongoApiRouter('/app-config', '/app-configs', 'evrika-smart-configs', [], {
    singleDataFilter: (param) => ({ _id: param.toString() }), postBodyModifier:(body) => ({...body, created_at:  moment().format("YYYY-MM-DD HH:mm:ss")})
  }),
]
